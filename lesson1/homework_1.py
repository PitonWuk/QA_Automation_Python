...
print(f"Всього посадили {result} дерев")
...
print(f"Evening temperature = {temp_evening}")
...
today_boys = 24 - 1
today_girls = girls - 2
result = today_boys + today_girls
print(f"Today are {result} children in the group")
